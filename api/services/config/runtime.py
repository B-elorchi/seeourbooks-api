...
def _defaults() -> dict[str, str]:
    return {
        ...
        "GEMINI_TTS_SPEAKER1_NAME":       "Host",
        "GEMINI_TTS_SPEAKER2_NAME":       "Guest",
        ...
        # Per-step on/off toggles (admin can disable any individual step)
        "PIPELINE_STEP_SUMMARIZE":                "true",
        "PIPELINE_STEP_TRANSLATE":                "true",
        "PIPELINE_STEP_AUDIO_FULL":               "true",
